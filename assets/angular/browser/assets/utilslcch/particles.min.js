...
var pJS = function (e, a) {
  ...
  a && Object.deepExtend(i, a), i.tmp.obj = {
    ...
    if ("image" == this.shape) {
      ...
      if (Array.isArray(o.image.src)) {
        // Seleccionar aleatoriamente una imagen y guardar el índice
        var imgIdx = Math.floor(Math.random() * o.image.src.length);
        var imgSrc = o.image.src[imgIdx];
        this.img = {
          src: imgSrc,
          width: o.image.width,
          height: o.image.height,
          ratio: o.image.width / o.image.height,
          imgIdx: imgIdx // Guardar el índice para usarlo al dibujar
        };
      } else {
        this.img = {
          src: o.image.src,
      ...
      for (var idx = 0; idx < srcs.length; idx++) {
        (function(idx) {
          ...
          if ("svg" == e) {
            ...
            a.open("GET", src), a.onreadystatechange = function (ev) {
              if (4 == a.readyState) {
                if (200 == a.status) {
                  if (!i.tmp.source_svg) i.tmp.source_svg = [];
                  i.tmp.source_svg[idx] = ev.currentTarget.response;
                  onImgLoaded();
                } else {
  ...
  i.fn.vendors.checkBeforeDraw = function () {
    ...
    // Detectar tipo de imagen correctamente cuando src es array
    var src = i.particles.shape.image.src;
    var imgType = "png";
    if (Array.isArray(src)) {
      if (src.length > 0) {
        imgType = src[0].substr(src[0].length - 3).toLowerCase();
      }
    } else if (typeof src === "string") {
      imgType = src.substr(src.length - 3).toLowerCase();
    }
    isInArray("image", i.particles.shape.type) ? i.fn.vendors.loadImg(imgType) : i.fn.vendors.checkBeforeDraw()
  },
